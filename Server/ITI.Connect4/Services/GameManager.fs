    ...
    interface IGameManager with
        ...
        member __.EvaluateBoard (board: Board) : GameState =
            let checkAt column row : Player option =
                ...
                let ascendingDiagonalCheck = GameWinningCondition(fun column row ->
                ...
                let descendingDiagonalCheck = GameWinningCondition(fun column row ->
                ...
                checkAt' [ horizontalCheck ; verticalCheck ; ascendingDiagonalCheck ; descendingDiagonalCheck ]
